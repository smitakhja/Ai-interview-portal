...
const COMPANIES = [
  ...
  { id: "tcs", name: "TCS", logo: "https://rankexdigital.com/wp-content/uploads/2024/08/TCS-logo.jpg", color: "#E02A6F", bg: "#FFF0F5", roles: ["Developer", "Analyst", "QA"], difficulty: "Easy", rounds: 3, desc: "TCS NQT, technical round and HR. Focus on basics and communication." },
...
const VIDEOS = [
  ...
  { id: "a3", company: "amazon", title: "Amazon Interview Questions & Preparation", youtubeId: "aWjoFr5JODU", duration: "35:00", views: "450K", tags: ["Preparation", "Amazon", "Guide"], difficulty: "Medium", questions: ["How to prepare for Amazon interviews?", "Important Leadership Principles", "Common coding patterns"] },
  { id: "m2", company: "microsoft", title: "Microsoft Interview Questions", youtubeId: "nZwVi7Affvc", duration: "40:00", views: "600K", tags: ["Questions", "Microsoft", "Guide"], difficulty: "Medium", questions: ["What questions does Microsoft ask?", "Technical round expectations", "System design topics"] },
  { id: "t2", company: "tcs", title: "TCS Interview Questions", youtubeId: "5KDHHXklG1Y", duration: "25:00", views: "300K", tags: ["TCS", "Interview", "Freshers"], difficulty: "Easy", questions: ["Common TCS HR questions", "Basic programming concepts", "Aptitude preparation"] },
  { id: "ap2", company: "apple", title: "Apple Interview Questions", youtubeId: "yy0f4e2W6cw", duration: "30:00", views: "250K", tags: ["Apple", "SWE", "Questions"], difficulty: "Hard", questions: ["Apple technical screening", "Behavioral questions at Apple", "Domain-specific questions"] },
  { id: "i2", company: "infosys", title: "Infosys Interview Questions", youtubeId: "af68Wv_gShc", duration: "20:00", views: "400K", tags: ["Infosys", "Interview", "Freshers"], difficulty: "Easy", questions: ["Infosys technical round", "HR round questions", "Resume-based questions"] },
  { id: "w2", company: "wipro", title: "Wipro Interview Questions and Answers", youtubeId: "XEqYVJlfC_g", duration: "22:00", views: "350K", tags: ["Wipro", "Answers", "Freshers"], difficulty: "Easy", questions: ["Wipro technical questions", "HR round discussion", "Common aptitude topics"] },
];
